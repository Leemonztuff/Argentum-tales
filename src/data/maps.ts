...
export const MAPS: Record<string, GameMap> = {
  ...
  pueblo_inicial: {
    ...
    npcs: [
      ...
      {
        id: 'npc_arsenal_prueba',
        name: 'Garin el Arsenalero',
        title: 'Intendente de Pruebas de Campo',
        sprite: '🎁⚔️',
        color: '#f59e0b',
        x: 8,
        y: 16,
        dialogue: [
          '¿Probando equipo nuevo? A mi me mandan todo el arsenal del reino para calibrar.',
          'Toma este kit de prueba: armas y armaduras de cada tipo. Nada de gamberradas, ¿eh?',
          'Cámbialo a gusto y verifica que se vea bien en tu espalda... y en la del enemigo.',
        ],
        givesItems: [
          { itemId: 'espada_corta', count: 1 },
          { itemId: 'espada_larga', count: 1 },
          { itemId: 'espada_caos', count: 1 },
          { itemId: 'hacha_barbara', count: 1 },
          { itemId: 'daga_simple', count: 1 },
          { itemId: 'daga_asesina', count: 1 },
          { itemId: 'arco_simple', count: 1 },
          { itemId: 'arco_compuesto', count: 1 },
          { itemId: 'baculo_aprendiz', count: 1 },
          { itemId: 'baculo_abismo', count: 1 },
          { itemId: 'tunica_lino', count: 1 },
          { itemId: 'armadura_cuero', count: 1 },
          { itemId: 'cota_malla', count: 1 },
          { itemId: 'armadura_placas', count: 1 },
        ],
      },
      {
        id: 'npc_capitan',
