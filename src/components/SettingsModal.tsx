...
import { Settings, Magnet, Sparkles, Volume2, VolumeX, Eye, Grid, ShieldAlert, CheckCircle2, Sliders, Filter, Coins, FlaskConical, TreePine, Swords, Scroll } from 'lucide-react';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <Modal
      ...
      onClose={handleClose}
      title="Ajustes & Preferencias de Juego"
