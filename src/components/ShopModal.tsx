...
export const ShopModal: React.FC<ShopModalProps> = ({
  ...
  return (
    <Modal
      isOpen={true}
      onClose={onClose}
      title={shopType === 'weapons' ? 'Herrería de Thorin' : shopType === 'crafting' ? 'El Coleccionista Errante' : 'Botica de Eliana'}
      icon={<span>{shopType === 'weapons' ? '🔨' : shopType === 'crafting' ? '📜' : '🧪'}</span>}
      size="lg"
      accent="#C89B3C"
      header={
