...
const fileStr = `import { GameMap } from '../types/game';
...
export const MAPS: Record<string, GameMap> = {
  ...
  dungeon_cripta: {
    id: 'dungeon_cripta',
    name: 'Cripta Maldita',
    subtitle: 'Mazmorra — 3 Salas + Jefe: Valgok el Lich',
    isSafe: false,
    isDungeon: true,
    ...
    chests: [
      {
        ...
        isOpened: false,
        gold: 300,
        items: [{ itemId: 'escudo_runico', count: 1 }, { itemId: 'pocion_azul', count: 3 }],
      },
    ],
    gatherNodes: [],
    npcs: [],
    mobSpawns: [
      // Room 1
      { mobId: 'esqueleto_guerrero', x: 8, y: 4, respawnSec: 20 },
      { mobId: 'esqueleto_guerrero', x: 18, y: 4, respawnSec: 20 },
      // Room 2
      { mobId: 'esqueleto_guerrero', x: 7, y: 13, respawnSec: 20 },
      { mobId: 'nigromante_cripta', x: 20, y: 14, respawnSec: 25 },
      // Boss Room 3
      { mobId: 'boss_lich_sombras', x: 13, y: 22, respawnSec: 60 },
    ],
  },
...
fs.writeFileSync('src/data/maps.ts', fileStr);
